...
const loadLocalstorageData = () =>  {
    ...
    chatlist.scrollTo(0, chatlist.scrollHeight); // scrool to the botttom
...
//set usermessage and handle outgoing chat whan a suggestion is clicked
...
// delete all chat from the page
deleteChatButton.addEventListener("click",() => {
    if(confirm("Are you sure bro... you want to delete all message?")) {
